...
$bilgi_no[23] = 'Kullanıcı hesabı silinmiştir.<br><br>Geri dönmek için <a href="kullanicilar.php?kip=engelli">tıklayın.</a>';

$bilgi_no[24] = 'Kullanıcının engeli kaldırılmıştır.<br><br>Geri dönmek için <a href="kullanicilar.php?kip=engelli">tıklayın.</a><br><br>Engeli olmayan kullanıcıları görmek için <a href="kullanicilar.php">tıklayın.</a>';

$bilgi_no[25] = 'Kullanıcı hesabı etkinleştirilmiştir.<br>Geri dönmek için <a href="kullanicilar.php?kip=etkisiz">tıklayın.</a><br><br>Etkinleştirilmiş kullanıcıları görmek için <a href="kullanicilar.php">tıklayın.</a>';

$bilgi_no[26] = 'Kullanıcı hesabı silinmiştir.<br><br>Geri dönmek için <a href="kullanicilar.php?kip=etkisiz">tıklayın.</a>';
...
$bilgi_no[32] = 'Üyenin profili güncellenmiştir, görmek için <a href="../profil.php?u='.$_GET['mesaj_no'].'">tıklayın.</a><br /><br />Etkin Kullanıcılar sayfasına dönmek için <a href="kullanicilar.php">tıklayın.</a><meta http-equiv="Refresh" content="5;url=kullanicilar.php">';

$bilgi_no[33] = 'Kullanıcı hesabı etkisizleştirilmiştir.<br>Geri dönmek için <a href="kullanicilar.php">tıklayın.</a><br><br>Etkinleştirilmemiş kullanıcıları görmek için <a href="kullanicilar.php?kip=etkisiz">tıklayın.</a>';

$bilgi_no[34] = 'Kullanıcı hesabı silinmiştir.<br><br>Geri dönmek için <a href="kullanicilar.php">tıklayın.</a>';

$bilgi_no[35] = 'Kullanıcı engellenmiştir.<br>Geri dönmek için <a href="kullanicilar.php">tıklayın.</a><br><br>Engellenmiş kullanıcıları görmek için <a href="kullanicilar.php?kip=engelli">tıklayın.</a>';
...
$bilgi_no[41] = 'Kullanıcı engellenmiştir.<br>Geri dönmek için <a href="kullanicilar.php?kip=etkisiz">tıklayın.</a><br><br>Engellenmiş kullanıcıları görmek için <a href="kullanicilar.php?kip=engelli">tıklayın.</a>';
...
$hata_no[145] = '<a href="kullanicilar.php">Bu sayfadan</a> istediğiniz üyenin kullanıcı adını tıklayın.<br><br>Açılan "Kullanıcı Profilini Değiştir" sayfasındaki, Diğer Yetkiler bağlantısını tıklayın.<br><br>Açılan sayfadan özel yetki vermek istediğiniz forumu seçerek kullanıcıya istediğiniz özel yetkiyi verebilirsiniz. ';
