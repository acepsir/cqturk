...
<link href="temalar/varsayilan/yonetim.css" rel="stylesheet" type="text/css" />
<?php
if ( ($secili_tema == 'varsayilan') AND ($ayarlar['forum_rengi'] == 'siyah'))
echo '<link href="../temalar/varsayilan/sablon_koyu.css" rel="stylesheet" type="text/css">';
?>
