...
<br>Bazı sunucularda sadece kullanıcı adı, bazılarındaysa KullanıcıAdı@AlanAdı.com şeklinde yazılması gerekebilir.
	...
	<td class="liste-veri" bgcolor="#ffffff" align="left">
<input class="formlar" type="text" name="smtp_kullanici" size="30" maxlength="100" value="<?php echo $smtp_kullanici; ?>">
	</td>
	</tr>
...
<br>smtp sunucu gerektiriyorsa doldurun.
	...
	<td class="liste-veri" bgcolor="#ffffff" align="left">
<input class="formlar" type="password" name="smtp_sifre" size="30" maxlength="100" value="sifre_degismedi">
	</td>
	</tr>
...
<input class="formlar" type="text" name="imza_uzunluk" size="4" maxlength="3" value="<?php echo $imza_uzunluk; ?>">
	...
	<tr>
	<td class="ana_forum_baslik" colspan="2" align="left" valign="middle" style="height:15px">
Kayıt Ayarları
	</td>
	</tr>
...
<!-- DÜZENLEYİCİ VE YÜKLEME AYARLARI - BAŞI  -->
...
<?php echo $duzenleyici; ?>
	...
	<tr>
	<td class="liste-veri" bgcolor="#ffffff" align="left" width="40%">
Hızlı Cevap Metin Düzenleyici:<br>
<font size="1">
...
<!-- DÜZENLEYİCİ VE YÜKLEME AYARLARI - SONU  -->
...
Üst logo için yazı veya resim ekleyin.
	...
	<td class="liste-veri" bgcolor="#ffffff" align="left">
<textarea class="formlar" name="tema_logo_ust" rows="1" style="height:35px; width:95%" cols="30"><?php echo $tema_logo_ust; ?></textarea>
	</td>
	</tr>
...
Alt logo için yazı veya resim ekleyin.
	...
	<td class="liste-veri" bgcolor="#ffffff" align="left">
<textarea class="formlar" name="tema_logo_alt" rows="1" style="height:35px; width:95%" cols="30"><?php echo $tema_logo_alt; ?></textarea>
	</td>
	</tr>
