...
{FORUM_ANASAYFA} &nbsp;&raquo;&nbsp; {FORUM_BASLIK} {ALT_FORUM_BASLIK}&nbsp;&raquo;&nbsp; {KONU_BASLIK}
</div>
...
<table cellspacing="1" width="100%" cellpadding="4" border="0" align="center" bgcolor="#d0d0d0">
...
Kayıt Tarihi: {KONU_ACAN_KAYIT}
<br>
İleti Sayısı: {KONU_ACAN_MESAJSAYI}
<br>
...
<div class="link-agaci" style="margin-top:10px">
