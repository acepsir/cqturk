...
<p>&nbsp; &nbsp; Forumdaki yazıların büyüklüğüne, sunucunuzun hızına ve yükleme yaptığınız andaki yoğunluğa bağlı olarak 3-5 bin girdi adımı bile kullanılabilir (toplam girdiye <a href="vt_yonetim.php">buradan bakın</a>). Önemli olan gzip sıkıştırlımış yedek dosyasının boyutudur. &nbsp; 700kb. dan büyük dosyaların yüklenmesi işlemleri yarım kalabilir.
...
<br>
&nbsp; 2mb.`dan büyük veritabanı ve/veya tablo yedekleri için <a href="vt_yedek.php?kip=gelismis">gelişmiş yedeklemeyi</a> kullanın.
<br><br><br>
