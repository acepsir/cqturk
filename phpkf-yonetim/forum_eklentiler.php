...
$dosya_adi = 'forum_eklentiler.php';
...
$yardim_konulari = 'Ayrıntılı bilgi için aşağıdaki konulara bakın.<br><br><a href="http://www.phpkf.com/k1902-eklentiler-kurulum-kaldirma-ve-etkisizlestirme.html">Eklenti Yükleme, Kurulum, Kaldırma ve Etkisizleştirme</a><br><br><a href="http://www.phpkf.com/k1904-eklenti-islemlerinde-olusabilecek-hatalar.html">Oluşabilecek Hatalar</a>';
...
{
	global $ayarlar, $tablo_oneki, $phpkf_dosyalar, $tablo_mesajlar, $tablo_kullanicilar, $tablo_tesekkur;
	...
	$bul = array(
	'bilesenler/', 'sayfa_baslik.php', 'yonetim/temalar/varsayilan/',
	'{VT_ONEK}mesajlar', '{VT_ONEK}kullanicilar', '{VT_ONEK}tesekkur', 
	'{VT_ONEK}', '{FORUM_INDEX}', '{PORTAL_INDEX}'
	);


	$cevir = array(
	'phpkf-bilesenler/', 'sayfa_baslik_forum.php', 'phpkf-yonetim/phpkf-bilesenler/temalar/varsayilan/',
	$tablo_mesajlar, $tablo_kullanicilar, $tablo_tesekkur, 
	$tablo_oneki, $phpkf_dosyalar['forum'], $phpkf_dosyalar['portal']
	);
...
if ( (isset($edbilgi['kur_veritabani'])) AND (is_array($edbilgi['kur_veritabani'])) AND (!isset($_GET['guncel'])) )
{
	...
	foreach($edbilgi['kur_veritabani'] as $a)
	{
		...
		{
			$a = str_replace(array('<', '>', "\n"), array('&lt;', '&gt;', '<br>'), $a);
			if (strlen($a) > 50) $a = substr($a, 0, 50).'...';
...
<form action="'.$dosya_adi.'?'.$guncelek.'kur='.$_GET['kur'].'" method="post" name="form1">
<input type="hidden" name="onay" value="onay" />
<input type="submit" class="dugme dugme-mavi" value="'.$kur_guncelle_dugme.'" />
</form>
	</center>';
}
...
else
{
	...
	if ($ev_hata == true)
	{
		...
		$eklenti_baslik = zkTemizle($edbilgi['eklenti_adi']);


		if (!isset($_GET['guncel']))
		{
			// Eklenti veritabanına ekleniyor - ilk kurulum
			$vtsorgu = "INSERT INTO $tablo_eklentiler (ad,baslik,kur,etkin,vt,dosya,dizin,sistem,usurum,esurum,ayar_kat)
			VALUES ('$_GET[kur]', '$eklenti_baslik', '1', '$eetkin', '$vt_islem', '$dosya_islem', '$dizin_islem', '$edbilgi[sistem]', '$uyumlu_surum', '$edbilgi[eklenti_surumu]', '0')";
			$vtsonuc = $vt->query($vtsorgu) or die ($vt->hata_ver());

			$esayfa_aciklama .= '<br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Kurulum başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'#'.$_GET['kur'].'">tıklayın.</a></b>';
		}
		...
		else
		{
			...
			$esayfa_aciklama .= '<br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Güncelleme başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'#'.$_GET['kur'].'">tıklayın.</a></b>';
		}
	}
...
<form action="'.$dosya_adi.'?kaldir='.$_GET['kaldir'].'" method="post" name="form1">
<input type="hidden" name="onay" value="onay" />
<input type="submit" class="dugme dugme-mavi" value="Kaldır" />
</form>
	</center>';
}
...
if ( (isset($_POST['onay'])) AND ($_POST['onay'] != '') )
{
	...
	else
	{
		...
		if ($ev_hata != false)
		{
			...
			$esayfa_aciklama .= '<br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Kaldırma işlemi başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'#'.$_GET['kaldir'].'">tıklayın.</a></b>';
		}
...
<form action="'.$dosya_adi.'?sil='.$_GET['sil'].'" method="post" name="form1">
<input type="hidden" name="onay" value="onay" />
<input type="submit" class="dugme dugme-mavi" value="Sil" />
</form>
	</center>';
}
...
if ( (isset($_POST['onay'])) AND ($_POST['onay'] != '') )
{
	...
	else
	{
		...
		if ($eklenti1->dizin_sil('../eklentiler/'.$_GET['sil']))
			$esayfa_aciklama .= '<br>'.$_GET['sil'].' = <font color="#669900"><b>dizin silindi</b></font><br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Silme işlemi başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'">tıklayın.</a></b>';
...
<br><br><br>
<form action="'.$dosya_adi.'?etkin='.$_GET['etkin'].'" method="post" name="form1">
<input type="hidden" name="onay" value="onay" />
<input type="submit" class="dugme dugme-mavi" value="Etkinleştir" />
</form>
</center>';
...
if ( (isset($_POST['onay'])) AND ($_POST['onay'] != '') )
{
	...
	$esayfa_aciklama = '<br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Etkinleştirme işlemi başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'#'.$_GET['etkin'].'">tıklayın.</a></b>';
}
...
<br><br><br>
<form action="'.$dosya_adi.'?etkisiz='.$_GET['etkisiz'].'" method="post" name="form1">
<input type="hidden" name="onay" value="onay" />
<input type="submit" class="dugme dugme-mavi" value="Etkisizleştir" />
</form>
</center>';
...
if ( (isset($_POST['onay'])) AND ($_POST['onay'] != '') )
{
	...
	$esayfa_aciklama = '<br><br><br><br><p align="center"><font style="font-size: 17px;"><b>Etkisizleştirme işlemi başarıyla tamamlanmıştır.</b><br><br></font><b>Geri dönmek için <a href="'.$dosya_adi.'#'.$_GET['etkisiz'].'">tıklayın.</a></b>';
}
...
<a href="'.$dosya_adi.'?kip=ayarlar">Ayarlar</a> sayfasına FTP bilgilerini girerek işlemin otomatik yapılmasını sağlayabilir veya FTP programınızla yazma hakkı verebilirsiniz. (chmod 777)<br>';
...
if ($_GET['kip'] == 'yukle'):
$sayfa_baslik2 = $ly['eklenti_yukle'];
$sayfa_kip = '<a href="'.$dosya_adi.'">'.$ly['eklentiler'].'</a> &nbsp; | &nbsp; <b>'.$ly['eklenti_yukle'].'</b> &nbsp; | &nbsp; <a href="'.$dosya_adi.'?kip=ayarlar">Dizin Ayarları</a>';
			...
			if ($zip_dosya === true)
			{
				...
				if ($zip_hata == '')
				{
					...
					if (!@is_file($xml_dosya))
						$esayfa_aciklama = '<br><p align="center"><font color="#ff0000"><b>Yükleme tamamlandı fakat eklentinin eklenti_bilgi.xml dosyası bulunamıyor.<br>Bu eklentiyi açıp (zipten çıkartıp) FTP programıyla /eklentiler/ dizinine kendiniz yükleyin.<br><br><br>Yüklü eklentileri görmek için <a href="'.$dosya_adi.'">tıklayın.</a></b></font>';
					...
					else
					{
						...
						if (!preg_match('|\<\?xml version="1.0" encoding="utf-8"\?\>\r\n\<phpKF_Eklenti\>|si', $xml_metni))
							$esayfa_aciklama = '<br><p align="center"><font color="#ff0000"><b>Yükleme tamamlandı fakat eklentinin eklenti_bilgi.xml dosyasının satır sonu kodu sorunlu yüklendi.<br>Bu eklentiyi açıp (zipten çıkartıp) FTP programıyla /eklentiler/ dizinine kendiniz yükleyin.<br><br><br>Yüklü eklentileri görmek için <a href="'.$dosya_adi.'">tıklayın.</a></b></font>';

						else $esayfa_aciklama = '<center><br><br><b>Yükleme Tamamlandı !</b><br><br>Yüklü eklentileri görmek için <a href="'.$dosya_adi.'#'.$dosyaya_git.'">tıklayın.</a></center>';
					}
				}
...
else $esayfa_aciklama = 'Bu sayfadan eklentileri sunucuya yükledikten sonra <a href="'.$dosya_adi.'">Eklentiler</a> sayfasından kurulum yapın.
...
<form name="eklenti_yukleme" action="'.$dosya_adi.'?kip=yukle" method="post" enctype="multipart/form-data" onsubmit="return denetle()">
<input type="hidden" name="yukleme" value="yapildi" />
<input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
<b>Dosya Seç: &nbsp;</b><input class="input-text" name="eklenti_yukle" type="file" size="200" style="width: 250px" />
<br><br><br>
&nbsp; &nbsp; &nbsp; <input class="dugme dugme-mavi" type="submit" value="Eklenti Yükle" />
</form></center>';
...
$sayfa_baslik2 = $ly['eklenti_ayarlari'];
$sayfa_kip = '<a href="'.$dosya_adi.'">'.$ly['eklentiler'].'</a> &nbsp; | &nbsp; <a href="'.$dosya_adi.'?kip=yukle">'.$ly['eklenti_yukle'].'</a> &nbsp; | &nbsp; <b>Dizin Ayarları</b>';
...
<form name="eklenti_ayarlari" action="'.$dosya_adi.'?kip=ayarlar" method="post" onsubmit="return denetle()">
<input type="hidden" name="onay" value="onay" />
...
<input class="input-text" type="text" name="ftp_sunucu" value="';
...
<input class="input-text" type="text" name="ftp_kullanici" size="30" maxlength="100" />
	</td>
	</tr>
...
<i>Şifre kaydedilmez.</i></font>
	...
	<td align="left" valign="top">
<input class="input-text" type="password" name="ftp_sifre" size="30" maxlength="100" />
	</td>
	</tr>
...
<i>Yanlış ise değiştirin.</i></font>
	...
	<td align="left" valign="middle">
	<input class="input-text" type="text" name="ftp_kok" value="public_html" size="30" maxlength="100" />
	</td>
	</tr>
...
<i>Yanlış ise değiştirin.</i></font>
	...
	<td align="left" valign="middle">
	<input class="input-text" type="text" name="f_dizin" value="'.$ayarlar['f_dizin'].'" size="30" maxlength="100" />
	</td>
	</tr>
...
<i>Bilmiyorsanız dokunmayın.</i></font>
	...
	<td align="left" valign="middle">
	<input class="input-text" type="text" name="dzn_chmod" value="0777" size="30" maxlength="4" />
	</td>
	</tr>
...
<i>Bilmiyorsanız dokunmayın.</i></font>
	...
	<td align="left" valign="middle">
	<input class="input-text" type="text" name="dsy_chmod" value="0777" size="30" maxlength="4" />
	</td>
	</tr>

	<tr class="tablo_ici">
	<td align="center" valign="middle" colspan="2" height="55">
<input class="dugme dugme-mavi" type="submit" value="İzinleri Değiştir" />
	</td>
	</tr>
</table>
</form>';
...
$sayfa_baslik2 = $ly['eklentiler'];
$sayfa_kip = '<b>'.$ly['eklentiler'].'</b> &nbsp; | &nbsp; <a href="'.$dosya_adi.'?kip=yukle">'.$ly['eklenti_yukle'].'</a> &nbsp; | &nbsp; <a href="'.$dosya_adi.'?kip=ayarlar">Dizin Ayarları</a>';
...
while ( @gettype($bilgi = @readdir($yedizin)) != 'boolean' )
{
	if ( (@is_dir($yedizin_adi.$bilgi)) AND ($bilgi != '.') AND ($bilgi != '..') )
	{
		...
		{
			$ekle_kaldir = '<br><br><br><a href="'.$dosya_adi.'?sil='.$bilgi.'" title="Bu Eklentiyi Sil">- Sil -</a>';
		...
		{
			$ekle_kaldir = '<br><br><a href="'.$dosya_adi.'?sil='.$bilgi.'" title="Bu Eklentiyi Sil">- Sil -</a>';
			$ebilgiler = '<font color="#ff0000"><b>Eklenti dizini:</b> '.$bilgi.'
		...
		else
		{
			...
			if ($ekl_satir['etkin'] == 1)
				$eklenti_etkin = '<br><br><a href="'.$dosya_adi.'?etkisiz='.$bilgi.'" title="Bu Eklentiyi Etkisizleştir">Etkisizleştir</a>';

			elseif ($ekl_satir['etkin'] == 0)
				$eklenti_etkin = '<br><br><a href="'.$dosya_adi.'?etkin='.$bilgi.'" title="Bu Eklentiyi Etkinleştir">Etkinleştir</a>';
			...
			elseif ($edbilgi['sistem'] == '4') $ebilgiler .= 'Tüm sistemler için';
			...
			if (isset($edbilgi['tema_adi'])) $ebilgiler .= '<br>Tema Değişikliği: '.@zkTemizle($edbilgi['tema_adi']);
			...
			if ( (isset($edbilgi['kur_veritabani'])) AND (is_array($edbilgi['kur_veritabani'])) AND (!isset($_GET['guncel'])) )
			{
				$ebilgiler2 .= '<b>Veritabanı Sorguları:</b> ';
				$dongu = 0;
				foreach($edbilgi['kur_veritabani'] as $a)
				{
					if ($a != '')
				...
				$ebilgiler2 .= $dongu.' adet<br><br>';
			}


			if ( (isset($edbilgi['degistirilecek_dosya'])) AND (is_array($edbilgi['degistirilecek_dosya'])) )
			{
				$ebilgiler2 .= '<b>Değiştirilecek Dosyalar:</b><br>';
				$dongu = 0;
				foreach($edbilgi['degistirilecek_dosya'] as $a)
				{
					if ($a != '')
			...
			if ( (isset($edbilgi['dizin_olustur'])) AND (is_array($edbilgi['dizin_olustur'])) )
			{
				$ebilgiler2 .= '<b>Oluşturulacak Dizinler:</b><br>';
				$dongu = 0;
				foreach($edbilgi['dizin_olustur'] as $a)
				{
					if ($a != '')
			...
			$ebilgiler3 = '<b>Açıklama:</b>&nbsp; '.$edbilgi['aciklama'].'';
			...
			if ($ekl_satir['kur'] == 1)
			{
				...
				elseif ( (!preg_match('/'.$ekl_satir['usurum'].'$/', $edbilgi['uyumlu_surum']))
					...
					<br><br><a href="'.$dosya_adi.'?guncel=1'.$guncelek.'&amp;kur='.$bilgi.'" title="Bu Eklentiyi Güncelle">- Güncelle -</a>';

				$ekle_kaldir .= '<br><br><a href="'.$dosya_adi.'?kaldir='.$bilgi.'">-Kaldır-</a></font><br><br><a href="'.$dosya_adi.'?sil='.$bilgi.'" title="Bu Eklentiyi Sil">- Sil -</a>'.$eklenti_etkin;
			}
			...
			else
			{
				...
				else $ekle_kaldir .= '<font color="#ff0000">Kurulu değil</font><br><br><a href="'.$dosya_adi.'?kur='.$bilgi.'" title="Bu Eklentiyi Kur">- Kur -</a>';
		...
		$depo = array('resim' => $eklenti_resim,
		'kaldir' => $ekle_kaldir,
		'ad' => $eklenti_adi,
		'aciklama1' => $ebilgiler,
		'aciklama2' => $ebilgiler2,
		'aciklama3' => $ebilgiler3);
...
if ((isset($depo1)) AND (isset($depo2))) $tekli1 = array_merge($depo1, $depo2);
elseif (isset($depo1)) $tekli1 = $depo1;
elseif (isset($depo2)) $tekli1 = $depo2;

if (!isset($tekli1)) $eklenti_yok = true;
...
$tema_sayfa_baslik = $sayfa_baslik2;
eval(phpkf_tema_yukle('phpkf-bilesenler/temalar/'.$temadizini_cms.'/forum_eklentiler.php'));
