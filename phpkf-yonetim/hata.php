...
$bilgi_no[1] = '<meta http-equiv="Refresh" content="5;url=ayarlar.php?kip='.str_replace('?git=', '', $git).'" />Değişiklik uygulandı, <a href="ayarlar.php?kip='.str_replace('?git=', '', $git).'">geri dönmek için tıklayın.</a>';
...
$bilgi_no[5] = 'Konuyu ve altındaki tüm cevapları silmek istediğinize emin misiniz ?<br><br><a href="../phpkf-bilesenler/mesaj_sil.php?onay=kabul&amp;kip=mesaj&amp;fno='.$_GET['fno'].'&amp;mesaj_no='.$_GET['mesaj_no'].'&amp;o='.$_GET['o'].$fs.'">Evet</a> &nbsp; - &nbsp; <a href="../konu.php?k='.$_GET['mesaj_no'].$fs.'">Hayır</a>';

$bilgi_no[6] = 'Konu ve tüm cevapları silinmiştir.<br><br>Foruma geri dönmek için <a href="../forum.php?f='.$_GET['fno'].$fs.'">tıklayın</a>';

$bilgi_no[7] = 'Cevabı silmek istediğinize emin misiniz ?<br><br><a href="../phpkf-bilesenler/mesaj_sil.php?onay=kabul&amp;kip=cevap&amp;mesaj_no='.$_GET['mesaj_no'].'&amp;cevap_no='.$_GET['cevap_no'].'&amp;o='.$_GET['o'].$fs.$ks.'">Evet</a> &nbsp; - &nbsp; <a href="../konu.php?k='.$_GET['mesaj_no'].$fs.$ks.'">Hayır</a>';
...
$bilgi_no[48] = 'Üye başarıyla oluşturulmuştur, geri dönmek için <a href="yeni_uye.php">tıklayın.</a><br><br>Üyenin profilini görmek için <a href="../profil.php?u='.$_GET['fno'].'">tıklayın.</a><br>Üyenin profilini değiştirmek için <a href="uye_degistir.php?u='.$_GET['fno'].'">tıklayın.</a>';
...
$bilgi_no[52] = 'Yorum silinmiştir.<br><br>Geri dönmek için <a href="forum_silinmis.php">tıklayın.</a>';

$bilgi_no[53] = 'Yorum başarıyla geri yüklenmiştir.<br><br>Geri dönmek için <a href="forum_silinmis.php">tıklayın.</a>';
...
$hata_no[2] = 'Eksik giriş yapıldı !';

$hata_no[3] = 'Eklenti dosyası bulunamıyor !';
...
$hata_no[6] = 'Yolladığınız son iletinin üzerinden<br>'.$ayarlar['yorum_sure'].' saniye geçmeden başka bir ileti gönderemezsiniz.';
...
$hata_no[21] = 'Beş başarısız giriş denemesi yaptınız.<br>'.($ayarlar['uye_kilit_sure'] / 60).' dakika boyunca hesabınız kilitlenmiştir.';
...
$hata_no[65] = 'Yolladığınız son iletinin üzerinden '.$ayarlar['yorum_sure'].' saniye geçmeden başka bir ileti gönderemezsiniz.';
...
$hata_no[73] = '* işaretli tüm alanların doldurulması zorunludur !';
...
$hata_no[78] = 'İmzanız '.$ayarlar['uye_imza_uzunluk'].' karakterden uzun olamaz !';
...
$hata_no[86] = 'Yüklemeye çalıştığınız resim '.($ayarlar['uye_resim_boyut']/1024).' kilobayt`dan büyük !';

$hata_no[87] = 'Yüklemeye çalıştığınız resmin boyutları '.$ayarlar['uye_resim_genislik'].'x'.$ayarlar['uye_resim_yukseklik'].'`den büyük !';

$hata_no[88] = 'Dosya yüklenemedi !<br><br>Yöneticiyseniz FTP programınızdan phpkf-dosyalar/resimler/yuklenen/<br>dizinine yazma hakkı vermeyi (chmod 777) deneyin.';
...
$hata_no[90] = 'Eklemeye çalıştığınız resim '.($ayarlar['uye_resim_boyut']/1024).' kilobayt`dan büyük !';

$hata_no[91] = 'Eklemeye çalıştığınız resmin boyutları '.$ayarlar['uye_resim_genislik'].'x'.$ayarlar['uye_resim_yukseklik'].'`den büyük !';
...
$hata_no[153] = 'Gün alanına 1 ila 9999 arasında bir sayı girmelisiniz.';
...
$hata_no[185] = 'Bu eklenti phpKF sürümü ile uyumsuz !<br><br>phpKF '.$forum_surum.' ile uyumlu eklentiyi indirin.';
...
$hata_no[196] = 'Bu tema phpKF sürümü ile uyumsuz !<br><br>phpKF '.$forum_surum.' ile uyumlu temayı indirin.';
...
$uyari_no[5] = 'Konuyu ve altındaki tüm cevapları silmek istediğinize emin misiniz ?<br><br><a href="../phpkf-bilesenler/mesaj_sil.php?onay=kabul&amp;kip=mesaj&amp;fno='.$_GET['fno'].'&amp;mesaj_no='.$_GET['mesaj_no'].'&amp;o='.$_GET['o'].'&amp;fsayfa='.$_GET['fsayfa'].'">Evet</a> &nbsp; - &nbsp; <a href="../konu.php?k='.$_GET['mesaj_no'].$fs.'">Hayır</a>';
...
$uyari_no[7] = 'Cevabı silmek istediğinize emin misiniz ?<br><br><a href="../phpkf-bilesenler/mesaj_sil.php?onay=kabul&amp;kip=cevap&amp;mesaj_no='.$_GET['mesaj_no'].'&amp;cevap_no='.$_GET['cevap_no'].'&amp;o='.$_GET['o'].'&amp;fsayfa='.$_GET['fsayfa'].'&amp;sayfa='.$_GET['sayfa'].'">Evet</a> &nbsp; - &nbsp; <a href="../konu.php?k='.$_GET['mesaj_no'].$ks.$fs.'">Hayır</a>';
