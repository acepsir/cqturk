...
if ($kip == 'dal_duzenle')
{
	...
	if (get_magic_quotes_gpc())
		$_POST['forum_baslik'] = @ileti_yolla(stripslashes($_POST['forum_baslik']), 4);

	//	magic_quotes_gpc kapalıysa	//
	else $_POST['forum_baslik'] = @ileti_yolla($_POST['forum_baslik'], 4);
...
elseif ($kip == 'forum_duzenle')
{
	...
	{
		$_POST['forum_baslik'] = @ileti_yolla(stripslashes($_POST['forum_baslik']), 4);
		$_POST['forum_bilgi'] = @ileti_yolla(stripslashes($_POST['forum_bilgi']), 4);
    }

	//	magic_quotes_gpc kapalıysa	//
    else
	{
		$_POST['forum_baslik'] = @ileti_yolla($_POST['forum_baslik'], 4);
		$_POST['forum_bilgi'] = @ileti_yolla($_POST['forum_bilgi'], 4);
    }
...
elseif ($kip == 'yeni_dal')
{
	...
	//	magic_quotes_gpc açıksa	//
	if (get_magic_quotes_gpc())
		$_POST['ana_forum_baslik'] = @ileti_yolla(stripslashes($_POST['ana_forum_baslik']), 4);

	//	magic_quotes_gpc kapalıysa	//
	else $_POST['ana_forum_baslik'] = @ileti_yolla($_POST['ana_forum_baslik'], 4);
