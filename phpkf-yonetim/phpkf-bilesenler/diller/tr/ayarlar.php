...
$lya['entegrasyon_ayarlari'] = 'Entegrasyon Ayarları';
$lya['forum_ayarlari'] = 'Forum Ayarları';
$lya['ozel_ileti_ayarlari'] = 'Özel ileti Ayarları';
$lya['yetki_adi_ayarlari'] = 'Yetki Adı Ayarları';
...
$lya['dizin']['baslik'] = 'phpKF Dizini';
$lya['dizin']['secenek'] = '';
$lya['dizin']['bilgi'] = 'phpKF Dizini';
$lya['dizin']['aciklama'] = 'phpKF`nin kurulu olduğu dizin. Yanlış girilmesi sitenin çalışmasını etkiler.<br />Dizinin sadece başına / ekleyin, sonuna <u>eklemeyin</u>. Kök dizini için sadece / girin.';


$lya['f_dizin']['baslik'] = 'Forum Dizini';
$lya['f_dizin']['secenek'] = '';
$lya['f_dizin']['bilgi'] = 'Forum Dizini';
$lya['f_dizin']['aciklama'] = 'Forumun kurulu olduğu dizin.<br />Dizinin sadece başına / ekleyin, sonuna <u>eklemeyin</u>. Kök dizini için sadece / girin.';
...
$lya['cms_kullan']['baslik'] = 'phpKF-CMS Kullanımı';
$lya['cms_kullan']['secenek'] = '1:Açık|0:Kapalı';
$lya['cms_kullan']['bilgi'] = '';
$lya['cms_kullan']['aciklama'] = 'CMS kurulu olmalıdır.';


$lya['forum_kullan']['baslik'] = 'phpKF Forum Kullanımı';
$lya['forum_kullan']['secenek'] = '1:Açık|0:Kapalı';
$lya['forum_kullan']['bilgi'] = '';
$lya['forum_kullan']['aciklama'] = 'Forum kurulu olmalıdır.';


$lya['portal_kullan']['baslik'] = 'phpKF-Portal Kullanımı';
$lya['portal_kullan']['secenek'] = '1:Açık|0:Kapalı';
$lya['portal_kullan']['bilgi'] = '';
$lya['portal_kullan']['aciklama'] = 'Portal kurulu olmalıdır.';


$lya['site_index']['baslik'] = 'Site Ana Sayfası';
$lya['site_index']['secenek'] = '1:CMS|2:Forum|3:Portal';
$lya['site_index']['bilgi'] = '';
$lya['site_index']['aciklama'] = 'Siteye ilk girişte gösterilecek yazılım. (/ ve index.php)';
...
// Forum Ayarları
$lya['fsyfkota']['baslik'] = 'Konu Sayısı';
$lya['fsyfkota']['secenek'] = '1:Açık|0:Kapalı';
$lya['fsyfkota']['bilgi'] = '';
$lya['fsyfkota']['aciklama'] = 'Bölüm sayfasında gösterilecek konu sayısı';


$lya['ksyfkota']['baslik'] = 'Cevap Sayısı';
$lya['ksyfkota']['secenek'] = '';
$lya['ksyfkota']['bilgi'] = '';
$lya['ksyfkota']['aciklama'] = 'Konu sayfasında gösterilecek cevap sayısı';


$lya['altforum_sira']['baslik'] = 'Alt Forum Sıralama Sayısı';
$lya['altforum_sira']['secenek'] = '';
$lya['altforum_sira']['bilgi'] = '';
$lya['altforum_sira']['aciklama'] = 'Forum ana sayfasındaki alt forum sıralama sayısı.';


$lya['sonkonular']['baslik'] = 'Güncel Konular';
$lya['sonkonular']['secenek'] = '1:Açık|0:Kapalı';
$lya['sonkonular']['bilgi'] = '';
$lya['sonkonular']['aciklama'] = 'Ana sayfadaki güncel konular';


$lya['kacsonkonu']['baslik'] = 'Güncel Konu Sayısı';
$lya['kacsonkonu']['secenek'] = '';
$lya['kacsonkonu']['bilgi'] = '';
$lya['kacsonkonu']['aciklama'] = 'Gösterilecek güncel konu sayısı';


$lya['bolum_kisi']['baslik'] = 'Görüntüleyen Sayısı';
$lya['bolum_kisi']['secenek'] = '1:Açık|0:Kapalı';
$lya['bolum_kisi']['bilgi'] = '';
$lya['bolum_kisi']['aciklama'] = 'Ana sayfa ve forum sayfalarında, ilgili forum bölümünü görüntüleyen kişi sayısı.';


$lya['konu_kisi']['baslik'] = 'Görüntüleyen Üyeler';
$lya['konu_kisi']['secenek'] = '1:Açık|0:Kapalı';
$lya['konu_kisi']['bilgi'] = '';
$lya['konu_kisi']['aciklama'] = 'Forum ve konu sayfalarında, görüntüleyen kişi sayısı ve üye adları.';
...
$lya['seo']['bilgi'] = '';
$lya['seo']['aciklama'] = 'Linkler çalışmazsa bu ayarı kapatın.<br />Sadece siteyi ilk kurduğunuzda değiştirin yoksa arama sitelerinin kaydettiği linkler geçersiz olur.<br />Seçenekler sadece CMS içindir, forum ve portal adresleri tek yapıdır.';


$lya['dizin_kat']['baslik'] = 'Kategoriler Dizini';
$lya['dizin_kat']['secenek'] = '';
$lya['dizin_kat']['bilgi'] = 'Kategoriler Dizini';
$lya['dizin_kat']['aciklama'] = '"Kategoriler" sayfası için gösterilecek sanal dizin. Yukarıdaki SEF ayarı ile bağlantılıdır.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';


$lya['dizin_sayfa']['baslik'] = 'Sayfalar Dizini';
$lya['dizin_sayfa']['secenek'] = '';
$lya['dizin_sayfa']['bilgi'] = 'Sayfalar Dizini';
$lya['dizin_sayfa']['aciklama'] = '"Sayfalar" sayfası için gösterilecek sanal dizin. Yukarıdaki SEF ayarı ile bağlantılıdır.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';


$lya['dizin_galeri']['baslik'] = 'Galeriler Dizini';
$lya['dizin_galeri']['secenek'] = '';
$lya['dizin_galeri']['bilgi'] = 'Galeriler Dizini';
$lya['dizin_galeri']['aciklama'] = '"Galeriler" sayfası için gösterilecek sanal dizin. Yukarıdaki SEF ayarı ile bağlantılıdır.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';


$lya['dizin_video']['baslik'] = 'Videolar Dizini';
$lya['dizin_video']['secenek'] = '';
$lya['dizin_video']['bilgi'] = 'Videolar Dizini';
$lya['dizin_video']['aciklama'] = '"Videolar" sayfası için gösterilecek sanal dizin. Yukarıdaki SEF ayarı ile bağlantılıdır.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';


$lya['dizin_etiket']['baslik'] = 'Etiketler Dizini';
$lya['dizin_etiket']['secenek'] = '';
$lya['dizin_etiket']['bilgi'] = 'Etiketler Dizini';
$lya['dizin_etiket']['aciklama'] = '"Etiketler" sayfası için gösterilecek sanal dizin.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';


$lya['dizin_arama']['baslik'] = 'Arama Dizini';
$lya['dizin_arama']['secenek'] = '';
$lya['dizin_arama']['bilgi'] = 'Arama Dizini';
$lya['dizin_arama']['aciklama'] = '"Arama" sayfası için gösterilecek sanal dizin.<br />Boşluk, büyük harf, Türkçe ve özel karakter kullanmayın.';
...
$lya['tarih']['bilgi'] = '';
$lya['tarih']['aciklama'] = '<br />Tüm sitede görünecek tarih biçimi. Ayrıntılı bilgi için aşağıdaki adreslere bakınız.<br /><br /><b>date() örnek:&nbsp;</b> 31.12.2017-23:59:59<br /><b>strftime() örnek:&nbsp;</b> 31 Aralık 2017 Çarşamba-23:59:59';
...
$lya['tarih_bicimi']['aciklama'] = 'Kullanım: <a href="http://www.php.net/date" target="_blank">date()</a>, <a href="http://www.php.net/strftime" target="_blank">strftime()</a><br /><p style="text-align:right">Ayarlı Görünüm: &nbsp;{phpkf_tarih}</p><b>date için:&nbsp;</b> d.m.Y-H:i:s<br /><b>strftime için:&nbsp;</b> %d %B %Y %A-%H:%M:%S<br />';
...
$lya['kayit_hesap_etkin']['aciklama'] = 'Kapalı: Etkinleştirme gerekmez.<br />Üye: Kayıt olan üyeye e-posta yollanarak doğrulama istenir.<br />Yönetici: E-posta doğrulamasına ek olarak yönetici onayı gerektirir.';
...
$lya['uye_uzak_resim']['baslik'] = 'Uzak Resim Özelliği';
$lya['uye_uzak_resim']['secenek'] = '1:Açık|0:Kapalı';
$lya['uye_uzak_resim']['bilgi'] = '';
$lya['uye_uzak_resim']['aciklama'] = 'Kullanıcıların url adresi göstererek başka sunuculardan resim eklemelerini sağlar.';
...
// Yetki Adı Ayarları
$lya['kurucu']['baslik'] = 'Kurucu Adı';
$lya['kurucu']['secenek'] = '';
$lya['kurucu']['bilgi'] = '';
$lya['kurucu']['aciklama'] = 'Kurucunun görünen adı';


$lya['yonetici']['baslik'] = 'Yönetici Adı';
$lya['yonetici']['secenek'] = '';
$lya['yonetici']['bilgi'] = '';
$lya['yonetici']['aciklama'] = 'Yöneticilerin görünen adı';


$lya['yardimci']['baslik'] = 'Yardımcı Adı';
$lya['yardimci']['secenek'] = '';
$lya['yardimci']['bilgi'] = '';
$lya['yardimci']['aciklama'] = 'Yardımcıların görünen adı';


$lya['blm_yrd']['baslik'] = 'Bölüm Yardımcısı Adı';
$lya['blm_yrd']['secenek'] = '';
$lya['blm_yrd']['bilgi'] = '';
$lya['blm_yrd']['aciklama'] = 'Bölüm yardımcılarının görünen adı';


$lya['kullanici']['baslik'] = 'Yetkisiz Üye Adı';
$lya['kullanici']['secenek'] = '';
$lya['kullanici']['bilgi'] = '';
$lya['kullanici']['aciklama'] = 'Kayıtlı kullanıcıların görünen adı';
...
$lya['site_posta']['aciklama'] = 'Site üzerinden gönderilecek e-postalarda kullanmak istediğiniz e-posta adresi.<br />Web sunucu veya smtp hesabınızla uyuşmazsa E-Posta gönderilemeyebilir.';
...
$lya['smtp_sunucu']['aciklama'] = 'SMTP sunucu adresini girin. Genelde mail.SiteAdresi.com şeklinde olur.<br />SMTP sunucu SSL güvenli bağlantı gerektiriyorsa adresin başına <b>ssl://</b> ekleyin.';


$lya['smtp_kullanici']['baslik'] = 'SMTP Kullanıcı Adı';
$lya['smtp_kullanici']['secenek'] = '';
$lya['smtp_kullanici']['bilgi'] = 'SMTP Kullanıcı Adı';
$lya['smtp_kullanici']['aciklama'] = 'SMTP sunucu gerektiriyorsa doldurun.<br />Bazı sunucularda sadece kullanıcı adı, bazılarındaysa KullanıcıAdı@SiteAdresi.com şeklinde yazılması gerekebilir.';
...
$lya['smtp_port']['bilgi'] = '';
$lya['smtp_port']['aciklama'] = 'Varsayılan smtp portu 25`dir. Türk Telekom 25. portu engellediği için Türkiye`de 587 kullanılmaktadır.<br />Sunucunuzun hangi portu kullandığını hosting firmanızdan öğrenebilirsiniz.';


// Özel ileti Ayarları
$lya['o_ileti']['baslik'] = 'Özel ileti Özelliği';
$lya['o_ileti']['secenek'] = '1:Açık|0:Kapalı';
$lya['o_ileti']['bilgi'] = '';
$lya['o_ileti']['aciklama'] = 'Özel ileti Özelliği';

$lya['oi_uyari']['baslik'] = 'Özel ileti E-Posta Uyarısı';
$lya['oi_uyari']['secenek'] = '1:Açık|0:Kapalı';
$lya['oi_uyari']['bilgi'] = '';
$lya['oi_uyari']['aciklama'] = '';

$lya['gelen_kutu_kota']['baslik'] = 'Gelen Kutusu Kotası';
$lya['gelen_kutu_kota']['secenek'] = '';
$lya['gelen_kutu_kota']['bilgi'] = '';
$lya['gelen_kutu_kota']['aciklama'] = 'Gelen Kutusu Kotası';

$lya['ulasan_kutu_kota']['baslik'] = 'Ulaşan Kutusu Kotası';
$lya['ulasan_kutu_kota']['secenek'] = '';
$lya['ulasan_kutu_kota']['bilgi'] = '';
$lya['ulasan_kutu_kota']['aciklama'] = 'Ulaşan Kutusu Kotası';

$lya['kaydedilen_kutu_kota']['baslik'] = 'Kaydedilen Kutusu Kotası';
$lya['kaydedilen_kutu_kota']['secenek'] = '';
$lya['kaydedilen_kutu_kota']['bilgi'] = '';
$lya['kaydedilen_kutu_kota']['aciklama'] = 'Kaydedilen Kutusu Kotası';
...
$lya['yukleme_dizin']['aciklama'] = 'Dosyaların yükleneceği dizini. Başına ve sonuna / (bölü) <u>koymayın.</u> Boş bırakılırsa phpKF kök dizini geçerli olur.<br />Yükleme işlemi için dizine yazma hakkı vermelisiniz. (chmod 777)<br />Varsayılan: phpkf-dosyalar/yuklemeler';
...
$lya['yukleme_dizin_uye']['aciklama'] = 'Her üyeye farklı klasör için dizin adında {uye_id} kullanabilirsiniz.<br />Varsayılan: phpkf-dosyalar/yuklemeler/uyeler/{uye_id}';
...
$lya['yukleme_boyut']['baslik'] = 'Azami Dosya Boyutu';
$lya['yukleme_boyut']['secenek'] = '';
$lya['yukleme_boyut']['bilgi'] = '';
$lya['yukleme_boyut']['aciklama'] = 'kilobayt (kb.) cinsinden en yüksek dosya boyutu.';
...
$lya['bduzenleyici']['baslik'] = 'BBCode Düzenleyici';
$lya['bduzenleyici']['secenek'] = 'varsayilan:phpKF';
$lya['bduzenleyici']['bilgi'] = '';
$lya['bduzenleyici']['aciklama'] = 'Forum, portal, özel ileti sayfalarında kullanılacak editör.';
...
$lya['duzenleyici_hizli_tema']['baslik'] = 'Hızlı Cevap Tasarım<br /><span style="font-size:11px;color:gray"><br />Hızlı cevap düzenleyici için</span>';
$lya['duzenleyici_hizli_tema']['secenek'] = 'varsayilan:Modern (koyu, büyük)';
$lya['duzenleyici_hizli_tema']['bilgi'] = '';
$lya['duzenleyici_hizli_tema']['aciklama'] = 'Hızlı cevap tasarımı. Klasik seçildiğinde düğmeler arasındaki ayraçlarları silmeniz önerilir.';


$lya['duzenleyici_font']['baslik'] = 'Simge Font Adresi';
$lya['duzenleyici_font']['secenek'] = '';
$lya['duzenleyici_font']['bilgi'] = 'Simge Font Adresi';
$lya['duzenleyici_font']['aciklama'] = 'Düğme simgelerinde kullanılan font adresi.<br />Varsayılan:&nbsp; https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css';
...
$lya['dugme_hizli']['baslik'] = 'Hızlı Cevap Düğmeler<br /><span style="font-size:11px;color:gray"><br />Hızlı cevap düzenleyici için</span>';
$lya['dugme_hizli']['secenek'] = '';
$lya['dugme_hizli']['bilgi'] = 'Hızlı cevap alanları için BBCode düğmeler';
...
$lya['tinymce_dosya']['aciklama'] = 'TinyMCE`nin çalışmasını sağlayan ana script dosyası. Varsayılan olarak uzak sunucudan yüklenir.<br />Varsayılan:&nbsp; https://cdn.tinymce.com/4/tinymce.min.js';


$lya['tinymce_dizin']['baslik'] = 'TinyMCE Dizini';
$lya['tinymce_dizin']['secenek'] = '';
$lya['tinymce_dizin']['bilgi'] = 'TinyMCE Dizini';
$lya['tinymce_dizin']['aciklama'] = 'TinyMCE dosyalarının bulunduğu dizin.<br />Varsayılan:&nbsp; phpkf-bilesenler/editor/tinymce/';


$lya['tinymce_language']['baslik'] = 'TinyMCE Dil Seçimi';
$lya['tinymce_language']['secenek'] = '';
$lya['tinymce_language']['bilgi'] = 'TinyMCE Dil Seçimi';
$lya['tinymce_language']['aciklama'] = 'Türkçe için (cdn) &nbsp; <b>language_url:tinymce_dizin+"/langs/tr_TR.js",</b><br />Türkçe için (yerel) &nbsp; <b>language:"tr_TR",</b><br />Otomatik seçim veya İngilizce için boş bırakın.';
...
// Tema Ayarları
$lya['tema_renk_cms']['baslik'] = 'Tema Rengi (CMS)';
$lya['tema_renk_cms']['secenek'] = '';
$lya['tema_renk_cms']['bilgi'] = '';
$lya['tema_renk_cms']['aciklama'] = 'Varsayılan olarak ayarlanmış temanın rengi.';


$lya['tema_renk']['baslik'] = 'Tema Rengi (Forum)';
$lya['tema_renk']['secenek'] = '';
$lya['tema_renk']['bilgi'] = '';
$lya['tema_renk']['aciklama'] = 'Varsayılan olarak ayarlanmış temanın rengi.';
...
$lya['tema_logo_ust']['baslik'] = 'Üst Logo Sol';
$lya['tema_logo_ust']['secenek'] = '';
$lya['tema_logo_ust']['bilgi'] = 'Üst Logo Sol';
$lya['tema_logo_ust']['aciklama'] = 'Sol üst logo için yazı veya resim ekleyin.  Resim eklemek için img etiketi kullanın ve resmin tam adresini yazın.<br />Örnek: &lt;a href="/"&gt;&lt;img src="http://siteadi.com/resim.jpg" style="position:absolute; left:0px; top:0px"&gt;&lt;/a&gt;<br />Örnekteki top ve left değerlerini değiştirerek logonun yerini ayarlayabilirsiniz.';


$lya['tema_logo_ust2']['baslik'] = 'Üst Logo Sağ';
$lya['tema_logo_ust2']['secenek'] = '';
$lya['tema_logo_ust2']['bilgi'] = 'Üst Logo Sağ';
$lya['tema_logo_ust2']['aciklama'] = 'Sağ üst logo için yazı veya resim ekleyin.  Resim eklemek için img etiketi kullanın ve resmin tam adresini yazın.<br />Örnek: &lt;a href="/"&gt;&lt;img src="http://siteadi.com/resim.jpg" style="position:absolute; right:0px; top:0px"&gt;&lt;/a&gt;<br />Örnekteki top ve right değerlerini değiştirerek logonun yerini ayarlayabilirsiniz.';


$lya['tema_logo_alt']['baslik'] = 'Alt Logo';
$lya['tema_logo_alt']['secenek'] = '';
$lya['tema_logo_alt']['bilgi'] = 'Alt Logo';
$lya['tema_logo_alt']['aciklama'] = 'Alt logo için yazı veya resim ekleyin. Resim eklemek için img etiketi kullanın ve resmin tam adresini yazın.<br />Örnek: &lt;a href="/"&gt;&lt;img src="http://siteadi.com/resim.jpg" style="position:absolute; left:0px; top:0px"&gt;&lt;/a&gt;<br />Örnekteki top değerini değiştirerek logoyu yukarı aşağı oynatabilirsiniz.';
