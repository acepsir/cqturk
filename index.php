...
$phpkf_ayarlar_kip = "";
if (!@include_once('ayar.php'))
{
	header('Location: kurulum/index.php');
	exit();
}

// güncelleme yapılmamışsa kurulum sayfasına yönlendir
if ($ayarlar['surum'] != '2.10')
{
	header('Location: kurulum/index.php');
	exit();
}
...
//  FORUM DALLARININ BİLGİLERİ ÇEKİLİYOR    //
...
<a href="ymesaj.php">Yeni iletiler</a> &nbsp;-&nbsp;
<a href="ymesaj.php?kip=bugun">Bugün Yazılanlar</a> &nbsp;-&nbsp;
<a href="ymesaj.php?kip=takip">Takip Edilenler</a>
...
{
	$tema_ic[$dongu1][] = array('{FORUM_KLASOR}' => $acik_forum.' alt="Herkese Açık Forum" title="Herkese Açık Forum"',
'{FORUM_OZEL_KLASOR}' =>  'src="temalar/'.$temadizini.'/resimler/forum01.gif" width="0" height="0" alt="boş"',
'{FORUM_BAGLANTI}' => '#',
'{FORUM_BASLIK}' => '</b></a><br><div align="center"><b>HENÜZ FORUM OLUŞTURULMAMIŞ</b></div><a href="#"><b>',
'{FORUM_BILGI}' => '',
'{FORUM_YARDIMCILARI}' => '',
'{FORUM_GOR}' => '',
'{SONMESAJ_BASLIK}' => '',
...
if ($forum_satir['okuma_izni'] == 0) $forum_klasor .= $acik_forum.' alt="Herkese Açık Forum" title="Herkese Açık Forum"';
elseif ($forum_satir['okuma_izni'] == 1) $forum_klasor .= $yonetici_forum.' alt="Sadece Yöneticilere Açık Forum" title="Sadece Yöneticilere Açık Forum"';
elseif ($forum_satir['okuma_izni'] == 2) $forum_klasor .= $yardimci_forum.' alt="Sadece Yöneticilere ve Yardımcılara Açık Forum" title="Sadece Yöneticilere ve Yardımcılara Açık Forum"';
elseif ($forum_satir['okuma_izni'] == 3) $forum_klasor .= $ozel_forum.' alt="Sadece Özel Yetkilere Sahip Üyelere Açık Forum" title="Sadece Özel Yetkilere Sahip Üyelere Açık Forum"';
elseif ($forum_satir['okuma_izni'] == 4) $forum_klasor .= $uyeler_forum.' alt="Sadece Üyelere Açık Forum" title="Sadece Üyelere Açık Forum"';
elseif ($forum_satir['okuma_izni'] == 5) $forum_klasor .= $kapali_forum.' alt="Kapalı Forum" title="Kapalı Forum"';
...
elseif ($kullanici_sayi > 20) $cevrimici_isimler .= ' <a href="cevrimici.php">...... devamı</a>';
...
else
{
	...
	$ornek1->kosul('5', array('{FORUM_DALI_YOK}' => 'HENÜZ FORUM DALI OLUŞTURULMAMIŞ'), true);
}
