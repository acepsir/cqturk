...
<div id="bildirimkt{SIRA}" class="liste-veri" align="left" style="position:relative; width:100%">
<div style="position:relative; width:41px; float:left; border-bottom:1px solid #e0e0e0; padding:7px; background:#fff"><b>{SIRA})</b></div>
...
<div style="position:relative; width:24px; float:left; border-left:1px solid #e0e0e0; border-bottom:1px solid #e0e0e0; padding:7px 7px 4px 15px; min-height:18px; background:#fff">
