...
<img src="phpkf-bilesenler/onay_kodu.php?a=1&amp;oturum={ONAY_ID}" title="<?php echo $l['onay_kodu_yazin']; ?>" alt="<?php echo $l['onay_kodu']; ?>" id="onaykodu" border="1" width="200" height="40" class="onay-kodu" /> &nbsp; &nbsp; 
...
<a href="javascript:void(0)" onclick="window.open('<?php echo $phpkf_dosyalar['kayit']; ?>?kosul=kabul', 'uyelik_kosul', 'resizable=yes,toolbar=0,status=0,width=670,height=475');return false">
