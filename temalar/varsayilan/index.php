...
<?php echo $l['toplam']; ?> <b>{CEVRIMICI_TOPLAM}</b> <?php echo $l['uye']; ?> <?php echo $l['cevrimici']; ?> (<b>{CEVRIMCI_UYE}</b> <?php echo $l['uye']; ?>, <b>{CEVRIMCI_GIZLI}</b> <?php echo $l['gizli']; ?>, <b>{CEVRIMCI_MISAFIR}</b> <?php echo $l['misafir']; ?>)
 &nbsp; 
...
{CEVRIMCI_ISIMLER}
<br><?php echo $cevrimici_bilgi; ?>

<br><a href="<?php echo $phpkf_dosyalar['cevrimici']; ?>"><?php echo $l['tum_cevrimici_goster']; ?></a>
	</td>
</tr>
...
<form name="giris" action="<?php echo $phpkf_dosyalar['giris']; ?>" method="post" onsubmit="return denetle()">
...
<tr bgcolor="#ffffff" class="mobil-gizle">
	...
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['herkese_acik']; ?></font></td>

	<td align="center" width="80"><img {UYELER_FORUM} alt="."></td>
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['uyelere_acik']; ?></font></td>

	<td align="center" width="80"><img {OZEL_FORUM} alt="."></td>
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['ozel_forum']; ?></font></td>
</tr>

<tr bgcolor="#ffffff" class="mobil-gizle">
	<td align="center" width="80"><img {YARDIMCI_FORUM} alt="."></td>
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['yardimcilara_acik']; ?></font></td>

	<td align="center" width="80"><img {YONETICI_FORUM} alt="."></td>
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['yoneticilere_acik']; ?></font></td>

	<td align="center" width="80"><img {KAPALI_FORUM} alt="."></td>
	<td align="left"><font class="liste-veri" style="font-size:13px">&nbsp;<?php echo $l['kapali_forum']; ?></font></td>
</tr>
