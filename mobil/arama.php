...
if (is_numeric($m_arama_satir['rakam']) == true)
    $konu_baslik_bag = '<a href="../mobil.php?ak='.$m_arama_satir['hangi_basliktan'].$sayfaya_git.'#c'.$m_arama_satir['cevap_id'].'">'.$konu_baslik.'</a>';

else $konu_baslik_bag = '<a href="../mobil.php?ak='.$m_arama_satir['id'].'">'.$konu_baslik.'</a>';
