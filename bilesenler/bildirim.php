...
if ($vt->num_rows($vtsonuc))
{
	...
	if ($bozel > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'ozel_ileti.php\'\">'.$bozel.' Yeni özel iletiniz var<br>Okumak için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($byorum > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'profil.php#yorum\'\">'.$byorum.' Yeni yorumunuz var<br>Okumak için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($bonay > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'onay.php\'\">'.$bonay.' Onaysız yazı var<br>Okumak için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($btsk > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'profil_degistir.php?kosul=bildirim\'\">'.$btsk.' Yeni teşekkür edildi<br>Görmek için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ( ($bcmsyorum > 0) AND ($kullanici_kim['yetki'] == 1) )
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'phpkf-yonetim/yorumlar.php\'\">'.$bcmsyorum.' Onaysız yorum var<br>Görmek için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($bsiparis > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'phpkf-yonetim/ozel_sayfa.php?s=../phpkf-bilesenler/eklentiler/urunler/urunler_yonetim.php&siparisler\'\">'.$bsiparis.' Sipariş var<br>Görmek için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($bodeme > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'phpkf-yonetim/ozel_sayfa.php?s=../phpkf-bilesenler/eklentiler/urunler/urunler_yonetim.php&siparisler\'\">'.$bodeme.' Ödeme var<br>Görmek için tıklayın</b>";'."\r\n";
		}
	}
	...
	if ($bcvp > 0)
	{
		...
		else
		{
			...
			$jbilyazi .= 'bilyazi['.$bsayi.'] = "<b onclick=\"BKapat('.$bsayi.');window.location.href=\''.$bldrm_dizin.'ymesaj.php\'\">'.$bcvp.' Yeni cevap var<br>Görmek için tıklayın</b>";'."\r\n";
		}
	}
}
...
if ($bgoster > 0)
{
echo '<link href="'.$bldrm_dizin.'temalar/'.$ayarlar['temadizini'].'/sablon_bildirim.css" rel="stylesheet" type="text/css">
<div id="bildirimk1" style="top:-16px" align="center">
<div id="bildirimk2">
<div id="bildirimk3" onMouseOver="Bildirim(\'bildirimk1\',1)"><b style="position:relative; top:-1px" title="Bildiriminiz Var" id="bildirimsayi">'.$bgoster.'</b></div>
<div id="bildirimk4" onMouseOver="Bildirim(\'bildirimk1\',1)" >
<div id="bildirimk5">
<div id="bildirimk6"><b style="cursor:pointer" title="Bildirimi kapatmak için tıklayın" onclick="BKapat(1)" id="bkapat">[X]</b>&nbsp;</div>
