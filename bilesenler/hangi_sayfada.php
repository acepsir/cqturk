...
{
	global $forum_index, $portal_index, $kullanici_kim;
	...
	switch ($sayfano)
	{
		...
		case 5;
		$sayfa = '<a href="cevrimici.php">Çevrimiçi Sayfası</a>';
		break;

		case 6;
		$sayfa = '<a href="bbcode_yardim.php">Yardım Sayfası</a>';
		break;

		case 7;
		$sayfa = '<a href="uyeler.php">Üyeler Sayfası</a>';
		break;

		case 8;
		$sayfa = '<a href="giris.php">Giriş Sayfası</a>';
		break;

		case 9;
		$sayfa = '<a href="kayit.php">Kayıt Sayfası</a>';
		break;

		case 10;
		$sayfa = '<a href="arama.php">Arama Sayfası</a>';
		break;
		...
		case 41;
		$sayfa = '<a href="mobil/index.php">Mobil Ana Sayfa</a>';
		break;

		case 42;
		$sayfa = '<a href="uyeler.php?kip=grup">Yetkililer ve Gruplar Sayfası</a>';
		break;
		...
		case 44;
		$sayfa = '<a target="_blank" href="https://play.google.com/store/apps/details?id=com.phpkf.mobil"><font color="#ff0000">phpKF Mobil Android Servis</font></a>';
		break;
		...
		case 47;
		$forumno = explode(',', $sayfano);
		$sayfa = 'Mobil Konu: <a href="mobil/index.php?ak='.$forumno[1].'">'.$baslik.'</a>';
		break;

		case 48;
		$forumno = explode(',', $sayfano);
		$sayfa = 'Mobil Forum: <a href="mobil/index.php?af='.$forumno[1].'">'.$baslik.'</a>';
		break;
