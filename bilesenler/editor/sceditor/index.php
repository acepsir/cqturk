...
if ( (isset($duzenleyici_bicim)) AND ($duzenleyici_bicim == 'html') )
{
	...
	style: "//www.sceditor.com/minified/jquery.sceditor.default.min.css"';

	$duzenleyici_js_ek = '<script type="text/javascript" src="//www.sceditor.com/minified/jquery.sceditor.xhtml.min.js"></script>';
}
...
else
{
	...
	style: "//www.sceditor.com/minified/jquery.sceditor.bbcode.min.css"';

	$duzenleyici_js_ek = '<script type="text/javascript" src="//www.sceditor.com/minified/jquery.sceditor.bbcode.min.js"></script>';
}
?>
...
<link rel="stylesheet" href="//www.sceditor.com/minified/themes/default.min.css" type="text/css" media="all" />
...
$(function() {
	...
	$("textarea").sceditor({
		width: "626",
		height: "400",
		emoticonsRoot: "//www.sceditor.com/",
