...
islem : "islem('"+duzenleyici_id+"', 'baglanti', prompt('Adresi Yazınız', 'http://'))",
ek : '',
};
...
islem : "islem('"+duzenleyici_id+"', 'resim', prompt('Resim Adresini Yazınız', 'http://'))",
ek : '',
};
...
islem : "islem('"+duzenleyici_id+"', 'eposta', prompt('E-Posta Adresini Yazınız', 'E-POSTA@ADRES.COM'))",
ek : '',
};
...
islem : "islem('"+duzenleyici_id+"', 'youtube', prompt('Youtube Adresini Yazınız', 'http://'))",
ek : '',
};
...
islem : "islem('"+duzenleyici_id+"', 'video', prompt('Video Adresini Yazınız', 'http://'))",
ek : '',
};
...
islem : "islem('"+duzenleyici_id+"', 'audio', prompt('Ses veya Müzik Adresini Yazınız', 'http://'))",
ek : '',
};
