...
$vtsorgu = "SELECT id,kullanici_adi,kullanici_kimlik,sifre,posta,resim FROM $tablo_kullanicilar WHERE kullanici_kimlik='$_COOKIE[kullanici_kimlik]' LIMIT 1";
...
//	UZAK RESİM YÜKLEME KISMI - BAŞI	//
	...
	elseif ( ($ayarlar['uye_uzak_resim'] == 1) AND (isset($_POST['uzak_resim'])) AND ($_POST['uzak_resim'] != '') OR 
		($ayarlar['uye_resim_galerisi'] == 1) AND (isset($_POST['uzak_resim2'])) AND ($_POST['uzak_resim2'] != '') )
	{
