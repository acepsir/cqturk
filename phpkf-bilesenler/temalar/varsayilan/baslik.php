...
<head>
<title><?php phpkf_tema_title(); ?></title>
...
<?php phpkf_tema_css(); ?>
<!--[if lt IE 8]>
<link href="phpkf-bilesenler/temalar/varsayilan/css/sablon_ie.css" rel="stylesheet" type="text/css" />
<![endif]-->
...
<li role="menuitem"><a href="phpkf-yonetim/index.php"><?php echo $lmenu['yonetim']; ?></a>
...
<ul class="sola-yasla" role="menu">
<?php
// Menü linklerini tema_ozellik.php tema dosyasındaki
...
<?php
// Reklam, duyuru, vs alanı
if ($ayarlar['tema_ust_alan_kod'] != ''): // Kod varsa alan gösteriliyor
if ($ayarlar['tema_ust_alan'] == 1): // Tasarımlı görünüm
?>

<div class="phpkf-blok-kutusu" style="margin-bottom:30px">
<div class="kutu-baslik"><?php echo $ayarlar['tema_ust_alan_baslik']; ?></div>
<div class="kutu-icerik"><?php echo $ayarlar['tema_ust_alan_kod']; ?></div>
</div>

<?php
else: // Tasarımsız görünüm
echo $ayarlar['tema_ust_alan_kod'];
endif; // tasarım durumu - koşul sonu
endif; // kod varsa - koşul sonu
?>