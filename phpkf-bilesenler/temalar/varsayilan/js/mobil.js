...
$("#sabit-menu").ilk().bul("ul").html($("#sabit-menu").ilk().bul("ul").html()+'<li class="devamivar">&raquo;</li>');
$("#genel-menu").ilk().bul("ul").html($("#genel-menu").ilk().bul("ul").html()+'<li class="devamivar">&raquo;</li>');
}
