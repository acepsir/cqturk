...
<div class="phpkf-blok-kutusu">
<div class="kutu-baslik"><?php echo $l['benzer_videolar']; ?></div>
<div class="kutu-icerik">
<ul class="kutu-liste">
<?php
...
?>
<span style="margin-left:10px;padding-left:7px;"><i>(<?php echo $l['bu_video']; ?>)</i></span>
...
else: echo '<center>'.$l['benzer_video_yok'].'</center>'; // Benzer yazı yoksa
