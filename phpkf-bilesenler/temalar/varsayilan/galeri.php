...
<div class="yazi-icerik" id="SlaytResimler">

<?php
preg_match_all('|<a href="(.*?)"><img src="(.*?)"></a>|is', $yazi['icerik'], $resimler, PREG_SET_ORDER);
foreach($resimler as $resim):
$dosya_adi = @end(@explode('/',$resim[2]));
?>
<div class="kategori-galeri">
<a href="<?php echo $resim[1]; ?>" title="<?php echo $dosya_adi; ?>">
<img class="SlaytKucukResim" src="<?php echo $resim[2]; ?>" alt="." />
<div class="kategori-galeri-yazi"><?php echo $dosya_adi; ?></div>
</a>
</div>
<?php endforeach; ?>
...
<?php
// içerikten resimler çıkartılıp, yazı varsa yazdırılıyor
$yazi['icerik'] = preg_replace('|<div class="resim_boyutlandir"><a(.*?)><img(.*?)></a></div>|is', '', $yazi['icerik']);
$yazi['icerik'] = preg_replace('|<img(.*?)>|is', '', $yazi['icerik']);
echo $yazi['icerik'];
...
<span class="kutu-yazar" title="Yazan"><?php echo '<a href="'.$yazi['profil'].'">'.$yazi['yazan'].'</a>'; ?></span>
...
<div class="phpkf-blok-kutusu">
<div class="kutu-baslik"><?php echo $l['benzer_galeriler']; ?></div>
<div class="kutu-icerik">
<ul class="kutu-liste">
<?php
...
?>
<span style="margin-left:10px;padding-left:7px;"><i>(<?php echo $l['bu_galeri']; ?>)</i></span>
...
else: echo '<center>'.$l['benzer_galeri_yok'].'</center>'; // Benzer yazı yoksa
...
<script src="phpkf-bilesenler/temalar/<?php echo $temadizini_cms; ?>/js/slayt.js" type="text/javascript"></script>
