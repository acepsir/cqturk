...
class sinif_vt
{
	...
	function hata_ver()
	{
		...
		if (@preg_match('/\/phpkf-bilesenler\//', $gadres)) $dosya_adi = 'log/veritabani.log.php';
		elseif ((@preg_match('/\/portal\//', $gadres)) OR (@preg_match('/\/mobil\//', $gadres)) OR (@preg_match('/\/mobil.php/', $gadres))) $dosya_adi = '../phpkf-bilesenler/log/veritabani.log.php';
		else $dosya_adi = 'phpkf-bilesenler/log/veritabani.log.php';
