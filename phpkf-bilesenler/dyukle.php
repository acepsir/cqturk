...
if (isset($_SERVER["HTTP_CF_CONNECTING_IP"])) $kul_ip = $_SERVER["HTTP_CF_CONNECTING_IP"];
else $kul_ip = $_SERVER['REMOTE_ADDR'];
$kul_ip = zkTemizle4($kul_ip);
$kul_ip = zkTemizle($kul_ip);
...
alan2.src="phpkf-bilesenler/dyukle.php";}
...
function kod_ekle(adres, dosya_adi)
{
	...
	var desen = new RegExp("/phpkf-yonetim/", "gi");
...
.forum-kategori-alt-baslik{
 background: #555 url("../resimler/baslik-arka.png") !important;
}
</style>';
...
$satir = "INSERT INTO $tablo_yuklemeler (tarih,boyut,ip,uye_id,uye_adi,dosya) VALUES ('$tarih', '$boyut', '$kul_ip', '$kullanici_kim[id]', '$kullanici_kim[kullanici_adi]', '$dosya_adi')";
