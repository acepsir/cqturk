...
//	DEĞİŞTİRMEYE YETKİLİ OLUP OLMADIĞINA BAKILIYOR	- SONU	//
    ...
    header('Location: ../hata.php?bilgi=4&fno='.$fno.'&mesaj_no='.$_POST['mesaj_no'].'&fsayfa='.$_POST['fsayfa'].'&sayfa='.$_POST['sayfa'].'&cevap_no='.$_POST['cevap_no']);
    exit();
}
...
{
	if (!isset($_SERVER['HTTP_REFERER'])) $_SERVER['HTTP_REFERER'] = $phpkf_dosyalar['forum'];
