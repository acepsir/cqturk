...
$lh['hata_iletisi'] = 'Error Message';
$lh['bilgi_iletisi'] = 'Info Message';
$lh['uyari_iletisi'] = 'Warning Message';
$lh['hatali_adres'] = 'Wrong Address!';
$lh['tikla_geri1'] = 'Click to go back.';
$lh['tikla_geri2'] = 'click to go back.';
$lh['tikla_geri3'] = 'Please go back and try again.';
$lh['tikla_giris'] = 'Click to login.';
$lh['tikla_hatirla1'] = 'Click if you don\'t remember the password.';
$lh['tikla_hatirla2'] = 'If you don\'t remember the username, click it.';
$lh['tikla_kayit'] = 'Click to register.';
$lh['tikla_anasayfa'] = 'Click to go to the homepage.';
$lh['tikla_profil'] = 'Click to see your profile.';
$lh['onay_kodu_hatali'] = 'The confirmation code is incorrect!';
$lh['spam_kutusu'] = 'Check your mailboxes may have fallen into the spam box.';
$lu['giris_yap'] = 'Sign in';
$lu['uye_ol'] = 'Sign up';
$lu['facebook_giris'] = 'You can log in with a Facebook account.';
...
$lb[500] = 'Your message has been received, thank you.'; // 23 -> 500 yapıldı

$lb[501] = 'Your comment has been added'; // 1 -> 501 yapıldı

$lb[502] = 'Your comment has been received and will be visible after you confirm it.'; // 2 -> 502 yapıldı
...
$lh[500] = 'The home page file is not found!<br /><br />File name entered'; // 46 -> 500

$lh[501] = 'Page not found!'; // 1->501

$lh[502] = 'Name, Last Name not entered!'; // 2->502

$lh[503] = 'Email address not entered!'; // 3->503

$lh[504] = 'You forgot to write a comment!'; // 4->504

$lh[505] = 'FORM EMPTY!'; // 5->505

$lh[506] = 'No home page post!'; // 7->506

$lh[507] = 'The message field can not be shorter than 10 characters!'; // 98->507

//$lh[508] = ''; // 99->508

$lh[509] = '"Title - Subject" field has invalid characters!<br /><br />Latin and Turkish letters, numbers, spaces, underscores ( _ ), dashes ( - ), periods ( . ) can be used. <br />They can not contain special characters outside of them.'; // 100->509

$lh[510] = '"Title - Subject" must be at least 4, at most 100 characters!'; // 101 -> 510
...
$lu[1] = 'Version updated!';

$lu[2] = 'Personal Message service is turned off!';
...
$lu[6] = 'Only members can access this page!';
...
$lu[8] = 'You have not made any changes.';

$lu[9] = 'Member recruitment has been temporarily suspended!';
