...
if (@include_once($site_dili.'/index.php')){$site_dili_js = $site_dili;}
elseif (@include_once($ayarlar['dil_varsayilan'].'/index.php')){$site_dili_js = $ayarlar['dil_varsayilan'];}
else {include_once('tr/index.php'); $site_dili_js = 'tr';}
