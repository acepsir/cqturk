...
INSERT INTO `$tablo_portal_ayarlar` VALUES ('portal_surum', '$guncel_surum');
...
INSERT INTO `$tablo_portal_haberler` VALUES (1, 1, 'phpKF`ye Hoş Geldiniz', 'Portal kurulumunuz başarıyla tamamlanmıştır...\n\nYönetici olarak giriş yaptığınızda üst menüde görünen [url=yonetim.php][u]Yönetim[/u][/url] bağlantısını tıklayarak, yönetimle ilgili işlemlere ulaşabilirsiniz.\n\nphpKF`yi seçtiğiniz için teşekkür ederiz...', 'phpkf,phpkf-portal,sürüm', '$yonetici_adi', '1', '127.0.0.1', '$tarih', 0, 1, 1);
