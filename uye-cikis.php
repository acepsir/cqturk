...
$vtsorgu = "UPDATE $tablo_kullanicilar SET son_hareket='$tarih', hangi_sayfada='$sayfa_adi', sayfano='$sayfa_numara', kul_ip='$ip' $eksorgu WHERE id='$kullanici_kim[id]'";
...
if ($gelinen == '') $adres = $phpkf_dosyalar['cms'].'?cikiss=1';
elseif ( (@preg_match('/giris.php/', $gelinen)) OR (@preg_match('/'.$phpkf_dosyalar['giris'].'/', $gelinen)) OR (@preg_match('/hata.php/', $gelinen)) OR (@preg_match('/'.$phpkf_dosyalar['hata'].'/', $gelinen)) OR (@preg_match('/phpkf-yonetim\//', $gelinen)) ) $adres = $phpkf_dosyalar['cms'].'?cikiss=1';
