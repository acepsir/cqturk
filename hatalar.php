...
$TEMA_HATA['BASLIK'] = $hata_baslik;
$TEMA_HATA['ICERIK'] = $hata_icerik;



// tema dosyaları yükleniyor
eval(phpkf_tema_yukle('phpkf-bilesenler/temalar/'.$temadizini_cms.'/hata.php'));
